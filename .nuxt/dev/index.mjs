globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/devalue/index.js';
import { createFetch as createFetch$1, Headers } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/nitropack/node_modules/defu/dist/defu.mjs';
import { hash as hash$1 } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unified/index.js';
import { toString } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/detab/index.js';
import { u } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/mdurl/index.js';
import slugify from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/slugify/slugify.js';
import { position } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unist-util-position/index.js';
import { visit } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unist-util-visit/index.js';
import { FontStyle, BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/madhavkapoor/repos/name-examination-upgrade/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/madhavkapoor/repos/name-examination-upgrade/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/madhavkapoor/repos/name-examination-upgrade/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/madhavkapoor/repos/name-examination-upgrade","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/madhavkapoor/repos/name-examination-upgrade/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/madhavkapoor/repos/name-examination-upgrade/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/madhavkapoor/repos/name-examination-upgrade/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/madhavkapoor/repos/name-examination-upgrade/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _X5EQ3J = defineEventHandler(async (event) => {
...
const _JjCQ3I = defineEventHandler(async (event) => {
...
const _aNWC0W = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_Qcs9Pg = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Qcs9Pg, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _X5EQ3J, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _X5EQ3J, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _X5EQ3J, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _JjCQ3I, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _aNWC0W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _aNWC0W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _aNWC0W, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_Qcs9Pg, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/madhavkapoor/repos/name-examination-upgrade/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
