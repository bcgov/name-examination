        ...
        <form class="flex items-center">
          ...
          <div class="relative w-full">
            ...
            <input
              ...
              type="text"
              class="w-72 h-14 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500
          ...
          <button
            type="submit"
            class="p-2.5 ml-3 text-sm font-medium text-white bg-blue-700 rounded-lg border
