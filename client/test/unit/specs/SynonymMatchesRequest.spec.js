...
describe('store > checkManualSynonymMatches', () => {
  ...
  it('replaces the plus with a space', () => {
    ...
    //
    //
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/ dog cat   fish /*')
  })
  ...
  it('keeps query as-is when there is no leading plus', () => {
    ...
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/dog/*')
  })
  ...
  it('replaces / and \\ with a space', () => {
    ...
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/dog cat  fish   bear /*')
  })
  ...
  it('replaces $ and ¢ with a dollar and cent, or s and c', () => {
    ...
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/big DOLLAR Store CENT aCCeptable /*')
  })
  ...
  it('escape special characters', () => {
    store.dispatch('checkManualSynonymMatches', {
      searchStr: '/?.><\\\'\":;\\|][}{=+_-)(*&^%$#@!~`ATHENAE/?.><\\\'\":;\\|][}{=+_-)(*&^%$#@!~`UM 139 LTD./?.><\\\'":;\\|][}{=+_-)(*&^%$#@!~`',
      exactPhrase: '',
    })

    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/ .>< \'; = _ * S@ATHENAE .>< \'; = _ * S@UM 139 LTD. .>< \'; = _ * S@/*')
  })
  ...
  it('sends exact phrase', () => {
    ...
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/testing exact phrase/exact phrase')
  })
  ...
  it('can search empty string', () => {
    ...
    expect(SynonymMatch.lastCall.args[0])
      .toEqual('/api/v1/requests/synonymbucket/*/*')
  })
})
